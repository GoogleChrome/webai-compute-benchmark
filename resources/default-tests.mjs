...
export const defaultSuites = [
    ...
    },
    {
        ...
        {
        name: "Image Segmentation (LiteRT) on wasm",
    ...
    {
        name: "Image Segmentation (LiteRT) on webgpu",
    ...
    {
        name: "Image Classification (LiteRT) on wasm",
    ...
    {
        name: "Image Classification (LiteRT) on webgpu",
    ...
    {
        name: "Hand Detection (LiteRT) on wasm",
    ...
    {
        name: "Hand Detection (LiteRT) on webgpu",
